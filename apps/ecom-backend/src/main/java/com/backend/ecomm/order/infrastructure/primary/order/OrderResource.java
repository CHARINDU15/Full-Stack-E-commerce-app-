...
import com.backend.ecomm.order.application.OrderApplicationService;
import com.backend.ecomm.order.domain.order.CartPaymentException;
import com.backend.ecomm.order.domain.order.aggregate.*;
import com.backend.ecomm.order.domain.order.vo.StripeSessionId;
import com.backend.ecomm.order.domain.user.vo.*;
...
import static com.backend.ecomm.product.infrastructure.primary.ProductsAdminResource.ROLE_ADMIN;
