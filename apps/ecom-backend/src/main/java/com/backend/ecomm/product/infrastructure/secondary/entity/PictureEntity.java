package com.backend.ecomm.product.infrastructure.secondary.entity;

import com.backend.ecomm.product.domain.aggregate.Picture;
import com.backend.ecomm.product.domain.aggregate.PictureBuilder;
